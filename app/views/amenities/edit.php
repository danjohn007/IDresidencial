    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 p-6">
            <div class="max-w-3xl mx-auto">
                <!-- Header -->
                <div class="mb-6">
                    <h1 class="text-3xl font-bold text-gray-900">✏️ Editar Amenidad</h1>
                    <p class="text-gray-600 mt-1">Modificar información de la amenidad</p>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="amenity_type" required 
                                    ...
                                    <option value="salon" <?php echo $amenity['amenity_type'] === 'salon' ? 'selected' : ''; ?>>Salón</option>
                            ...
                            <div>
                                ...
                                <input type="number" name="capacity" required min="1"
                                       value="<?php echo $amenity['capacity']; ?>"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div>
                                ...
                                <input type="time" name="hours_open" required 
                                       value="<?php echo $amenity['hours_open']; ?>"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="time" name="hours_close" required 
                                       value="<?php echo $amenity['hours_close']; ?>"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="requires_payment" 
                                    ...
                                    <option value="0" <?php echo !$amenity['requires_payment'] ? 'selected' : ''; ?>>No (Gratis)</option>
                                    <option value="1" <?php echo $amenity['requires_payment'] ? 'selected' : ''; ?>>Sí</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="hourly_rate" id="hourly_rate" min="0" step="0.01"
                                       value="<?php echo $amenity['hourly_rate']; ?>"
                                       <?php echo !$amenity['requires_payment'] ? 'disabled' : ''; ?>
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                       placeholder="0.00">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="status" required 
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="active" <?php echo $amenity['status'] === 'active' ? 'selected' : ''; ?>>Activa</option>
                                    <option value="inactive" <?php echo $amenity['status'] === 'inactive' ? 'selected' : ''; ?>>Inactiva</option>
                                </select>
                            </div>
                        </div>
