    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 p-6">
            ...
            <div class="bg-white rounded-lg shadow p-8 text-center text-gray-500">
                ...
                <p>No hay reportes de áreas comunes registrados.</p>
            </div>
            <?php else: ?>
                        ...
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                ...
                                <div class="flex items-center space-x-4 text-sm text-gray-500">
                                    ...
                                    <span><i class="fas fa-map-marker-alt mr-1"></i> <?php echo htmlspecialchars($report['location']); ?></span>
                                    <?php endif; ?>
                            ...
                            <div class="ml-4 flex flex-col space-y-2">
                                <?php if (in_array($_SESSION['role'], ['superadmin', 'administrador'])): ?>
                                    <form method="POST" action="<?php echo BASE_URL; ?>/maintenance/updateStatus/<?php echo $report['id']; ?>" class="inline-block">
                                        <input type="hidden" name="_redirect" value="maintenance/commonAreas">
