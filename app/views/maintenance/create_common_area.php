    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 p-6">
            <div class="max-w-3xl mx-auto">
                <!-- Header -->
                <div class="mb-6">
                    <h1 class="text-3xl font-bold text-gray-900"><i class="fas fa-city mr-2 text-blue-600"></i>Nuevo Reporte - Área Común</h1>
                    <p class="text-gray-600 mt-1">Registrar incidencia en áreas comunes del residencial</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <form method="POST" action="<?php echo BASE_URL; ?>/maintenance/createCommonArea">
                        <div class="space-y-4">
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="location" required
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                       placeholder="Ej: Jardín principal, Piscina, Salón de eventos, etc.">
                            </div>
