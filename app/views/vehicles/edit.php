        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 p-6">
            <div class="max-w-3xl mx-auto">
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 mt-1">Modificar datos del vehículo</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <form method="POST" action="<?php echo BASE_URL; ?>/vehicles/edit/<?php echo $vehicle["id"]; ?>">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="resident_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    <?php foreach ($residents as $resident): ?>
                                        <option value="<?php echo $resident['id']; ?>" <?php echo $resident['id'] == $vehicle['resident_id'] ? 'selected' : ''; ?>>
                            ...
                            <div>
                                ...
                                <select name="vehicle_type" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="auto" <?php echo $vehicle['vehicle_type'] === 'auto' ? 'selected' : ''; ?>>Auto</option>
                            ...
                            <div>
                                ...
                                <select name="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="active" <?php echo $vehicle['status'] === 'active' ? 'selected' : ''; ?>>Activo</option>
                                    <option value="inactive" <?php echo $vehicle['status'] === 'inactive' ? 'selected' : ''; ?>>Inactivo</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end space-x-4 mt-6">
                            ...
                            <button type="submit" 
                                ...
                                <i class="fas fa-save mr-2"></i>Editar Vehículo
                            </button>
                        </div>
                    </form>
                </div>
