    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 p-6">
            <div class="mb-6 flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><i class="fas fa-edit mr-2 text-yellow-600"></i>Editar Proveedor</h1>
                </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form method="POST" action="<?php echo BASE_URL; ?>/providers/edit/<?php echo $provider['id']; ?>" class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <select name="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500">
                                <option value="active" <?php echo ($provider['status'] ?? '') === 'active' ? 'selected' : ''; ?>>Activo</option>
                                <option value="inactive" <?php echo ($provider['status'] ?? '') === 'inactive' ? 'selected' : ''; ?>>Inactivo</option>
                            </select>
                        </div>
                    </div>
                    <div>
