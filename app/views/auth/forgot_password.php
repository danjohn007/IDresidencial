...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 px-4">
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">¿Olvidaste tu contraseña?</h2>
            ...
            <p class="text-gray-600 mb-6">
                Ingresa tu correo electrónico y te contactaremos para ayudarte a recuperar tu contraseña.
            </p>
