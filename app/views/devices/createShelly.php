                    ...
                    <form method="POST" action="<?php echo BASE_URL; ?>/devices/createShelly">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="area" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="">Seleccionar área...</option>
                                    <?php if (!empty($deviceAreas)): ?>
                                        <?php foreach ($deviceAreas as $area): ?>
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    <a href="<?php echo BASE_URL; ?>/devices/areas" class="text-blue-600 hover:underline">Administrar áreas</a>
                                </p>
                            </div>
