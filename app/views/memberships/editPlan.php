    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 p-6">
            <div class="mb-6">
                ...
                <h1 class="text-3xl font-bold text-gray-900">✏️ Editar Plan de Membresía</h1>
                <p class="text-gray-600 mt-1">Actualice la información del plan</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" 
                                      ...
                                      rows="3"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                      placeholder="Descripción del plan"><?php echo htmlspecialchars($plan['description'] ?? ''); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" 
                                       id="monthly_cost" 
                                       name="monthly_cost" 
                                       value="<?php echo htmlspecialchars($plan['monthly_cost']); ?>"
                                       step="0.01"
                                       min="0"
                                       required
                        ...
                        <div>
                            ...
                            <select id="is_active" 
                                    name="is_active"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                <option value="1" <?php echo $plan['is_active'] ? 'selected' : ''; ?>>Activo</option>
                                <option value="0" <?php echo !$plan['is_active'] ? 'selected' : ''; ?>>Inactivo</option>
                            </select>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="benefits" 
                                      ...
                                      placeholder="Acceso a alberca&#10;Acceso a gimnasio&#10;2 reservaciones mensuales"><?php echo htmlspecialchars($benefitsText); ?></textarea>
